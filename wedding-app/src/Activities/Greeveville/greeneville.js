...
import cosbyPic from '../../pictures/cosby.jpg'
...
function Greeneville({ onClose }) {
    ...
    const homeDis = (
        <div>
            ...
            <p>
                ...
                this cute little town! On December 23, 2024 Sam dropped down on one knee and proposed to Jelena during "family Christmas photos" on this property so it's a very special place to us. During the Civil War Greeneville held both Union and Southern soldiers and
    ...
    const jonesborough = (
        <div>
            ...
            <p><a href="https://maps.app.goo.gl/rs3MnvpaBb3yJpxQ7" target="_blank" rel="noreferrer">Jonesborough</a> is a cute little town with some good coffee and ice cream. They have an adorable downtown area with a lot of cute shops.
                Tennessee Hills, a distillary that has grown over the years, is located in this town and is one of our favorites.
    ...
    const cosby = (
        <div>
            <h1>Cosby</h1>
            <p>If you want more outdoor adventures head west about an hour to
                <a href="https://maps.app.goo.gl/TtDXaNYmbx1iMy438" target="_blank" rel="noreferrer"> Cosby Tennessee </a>
            </p>

            <p>
                On your way to these hikes, you will drive through a little town called Newport. There is a cute coffee shop, Snowbird Mountain Coffee. This is a perfect place to stop and fuel up.

             </p>

            <p>
                There are several hikes I will recommend. The first is Lower Mount Cammerer Trailhead. You can take several trails ranging from a simple hike
                to an all-day adventure. This Trailhead will take you to the very east side of the Smoky Mountains.

            </p>

            <p>
                From this trailhead you can reach the Mount Cammerer Lookout Tower. This will take you to the peak of a mountain where an old fire lookout stands.
                Beware, this hike is 10 miles roundtrip and it took Sam 4 hours and 50 minutes to complete. He ended up burning 2405 calories! This is a difficult trek, please brings lots of water, snacks, and enjoy the views! 
            </p>

            <p>
                 There are many other outdoor activities in this town!
            </p>
            ...
            <ul className="greeneville-list">
                <li>Hike: 
                    <a href="https://share.google/ZrfHtFuW8oK4gycUz" target="_blank" rel="noreferrer">
                        Lower Mount Cammerer Trailhead</a>
                </li>
                <li>Hike: 
                    <a href="https://share.google/MbqN88zDSLKqOsnKY" target="_blank" rel="noreferrer">
                        Mount Cammerer Lookout Tower</a>
                </li>
                <li>Coffee and Food: 
                    <a href="https://maps.app.goo.gl/8jHCMxvWHwmnXcSY9" target="_blank" rel="noreferrer">
                        Snowbird Mountain Coffee</a>
                </li>
    ...
    return (
        ...
        <div className='greenevilleBackground'>
            ...
            <div className='greeneville-content'>
                ...
                {/*Crosby city*/}
                <div className='greeneville-info'>
                    <p>Cosby (~1 hr from Greeneville)</p>
